...
const DayTwoPartTwo = () => {
    ...
    const moveDictionary = {A: 'Rock', B: 'Paper', C: 'Scissors', X: 'Lose', Y: 'Draw', Z: 'Win'}
    const choiceDictionary = {  'Rock Lose': 'Scissors', 'Rock Win': 'Paper', 'Rock Draw': 'Rock',
                                'Paper Lose': 'Rock', 'Paper Win': 'Scissors', 'Paper Draw': 'Paper',
                                'Scissors Lose': 'Paper', 'Scissors Win': 'Rock', 'Scissors Draw': 'Scissors'
                            }
    ...
    const calculateRowTotal = (item) => {
        ...
        const returnValue = [moveDictionary[arraySplit[0]], choiceDictionary[`${moveDictionary[arraySplit[0]]} ${moveDictionary[arraySplit[1]]}`]]
